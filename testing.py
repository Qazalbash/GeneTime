...
# def getTimeTable(classDetails):
#     data = DataCleaning("Spring 2023 Schedule.csv", "Spring 2023 student enrollment.csv")
...
#         for classNumber, instances in classDetails.items():
#             class_info = data.df.loc[data.df['Class nbr'] == classNumber, ['Program', 'Course code', 'Course title', 'Section', 'Instructor', 'Actual Class Duration']].iloc[0].tolist()
#             for instance in instances:
#                 day = instance[0]
#                 room = instance[1]
#                 start_time = instance[2]
#                 end_time = instance[3]
#                 row = [day, start_time, end_time, class_info[0], class_info[1], class_info[2], classNumber, class_info[3], room, class_info[4], class_info[5]]
#                 writer.writerow(row)


# getTimeTable(classDetails)